        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-100">FarmMart</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/help" className="hover:text-emerald-500 transition">
                  Help Center
                </Link>
              </li>
              <li>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-100">Stay in touch</h4>
            <p className="text-gray-400 mb-4">Get updates on new listings and offers.</p>
            <form className="flex gap-2">
              <input placeholder="Your email" className="flex-1 px-3 py-2 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 bg-gray-800 text-gray-100" />
