  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            <div className="flex flex-col items-center text-center gap-2">
              ...
              <div className="text-3xl font-bold text-emerald-600">{totalUsersCount}</div>
          ...
          <Card>
            <div className="flex flex-col items-center text-center gap-2">
              ...
              <div className="text-3xl font-bold text-emerald-600">{activeListings}</div>
          ...
          <Card>
            <div className="flex flex-col items-center text-center gap-2">
              ...
              <div className="text-3xl font-bold text-emerald-600">{totalOrdersCount}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            { title: "User Management", desc: "Manage platform users", href: "/admin/users", label: "Manage Users" },
            { title: "Analytics", desc: "View platform statistics", href: "/admin/analytics", label: "View Analytics" },
            { title: "Content Moderation", desc: "Review listings and reports", href: "/admin/moderation", label: "Moderate Content" },
            { title: "Pending Orders", desc: `${pendingOrders} orders awaiting action`, href: "/admin/orders", label: "View Orders" },
              ...
              {allOrders.slice(0, 5).map((order) => (
                <div key={order.id} className="flex justify-between items-center py-2 border-b">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{order.users?.name || "Unknown"}</div>
                  </div>
